...
The actual implementation has moved to src/qbt_rules/cli/on_completed.py

For new installations, use the console script instead:
    qbt-on-completed <torrent_hash>

Or run as a Python module:
    python -m qbt_rules.cli.on_completed <torrent_hash>
"""

from qbt_rules.cli.on_completed import main
