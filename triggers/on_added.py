...
The actual implementation has moved to src/qbt_rules/cli/on_added.py

For new installations, use the console script instead:
    qbt-on-added <torrent_hash>

Or run as a Python module:
    python -m qbt_rules.cli.on_added <torrent_hash>
"""

from qbt_rules.cli.on_added import main
